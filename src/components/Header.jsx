            ...
            <nav className='container mx-auto'>
                <div className="navbar bg-base-100">
                    ...
                    <div className="navbar-end ">
                        {
                            !user ? <Link to="/login" className="btn btn-info text-white">Account <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
